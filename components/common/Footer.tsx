...
const Footer = () => {
  return (
    <footer className="bg-[#111827] text-gray-300 font-sans border-t-4 border-red-600">
      <div className="max-w-[1224px] mx-auto px-4 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-5">
            <h2 className="text-3xl font-bold text-white tracking-tighter">
              S@ifur's <span className='text-red-500 text-sm font-normal tracking-widest uppercase block mt-1'>Publications</span>
            </h2>
            <p className="text-gray-400 text-sm leading-6 max-w-sm border-l-2 border-red-600 pl-4">
              ইংরেজি শেখা এবং ক্যারিয়ার গড়ার নির্ভুল ও সহজ গাইডলাইন পৌঁছে দেওয়াই আমাদের লক্ষ্য। 
            </p>
            {/* Social Buttons */}
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 text-center text-xs text-gray-500">
          <p>© ২০২৫ সাইফুরস পাবলিকেশনস। সর্বস্বত্ব সংরক্ষিত।</p>
        </div>
